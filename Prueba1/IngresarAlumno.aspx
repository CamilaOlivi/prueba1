<%@ Page Language="vb" AutoEventWireup="false" CodeBehind="IngresarAlumno.aspx.vb" Inherits="Prueba1.WebForm1" %>
...
<body>
    <form id="form1" runat="server">
        <div>
            <asp:FormView ID="IngresoAlumnos" runat="server" DataSourceID="SqlDataSource1" DataKeyNames="Id" BorderStyle="Double" AllowPaging="True" DefaultMode="Insert">
                <EditItemTemplate>
                    Id:
                ...
                <ItemTemplate>
                    ...
                    <asp:LinkButton runat="server" Text="Nuevo" CommandName="New" ID="NewButton" CausesValidation="False" />
                </ItemTemplate>
            </asp:FormView>
            <asp:SqlDataSource runat="server" ID="SqlDataSource1" ConnectionString="<%$ ConnectionStrings:PruebaProgramacionConnectionString %>" OldValuesParameterFormatString="original_{0}" SelectCommand="SELECT Registro_Alumnos.* FROM Registro_Alumnos" InsertCommand="INSERT INTO [Registro_Alumnos] ([Rut_Alumno], [Nombre_Alumno], [Apellido_Alumno], [Fecha_Ingreso], [Edad], [Telefono], [Dirección]) VALUES (@Rut_Alumno, @Nombre_Alumno, @Apellido_Alumno, @Fecha_Ingreso, @Edad, @Telefono, @Dirección)">
                <InsertParameters>
